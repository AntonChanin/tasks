...
window.onkeyup = function (event) {
    ...
    switch (event.key) {
        ...
        case 'Win': document.body.querySelector('.win').classList.remove('use'); break;
...
window.onkeydown = function (event) {
    ...
    switch (event.key) {
        ...
        case 'É': document.body.querySelector('.' + event.key).classList.add('use'); break;
        case 'Ö': document.body.querySelector('.' + event.key).classList.add('use'); break;
        case 'Ó': document.body.querySelector('.' + event.key).classList.add('use'); break;
        case 'Ê': document.body.querySelector('.' + event.key).classList.add('use'); break;
        case 'Å': document.body.querySelector('.' + event.key).classList.add('use'); break;
        case 'Í': document.body.querySelector('.' + event.key).classList.add('use'); break;
        case 'Ã': document.body.querySelector('.' + event.key).classList.add('use'); break;
        case 'Ø': document.body.querySelector('.' + event.key).classList.add('use'); break;
        case 'Ù': document.body.querySelector('.' + event.key).classList.add('use'); break;
        case 'Ç': document.body.querySelector('.' + event.key).classList.add('use'); break;
        case 'Õ': document.body.querySelector('.StartQBracket').classList.add('use'); break;
        case 'Ú': document.body.querySelector('.EndQBracket').classList.add('use'); break;
        case 'Ô': document.body.querySelector('.' + event.key).classList.add('use'); break;
        case 'Û': document.body.querySelector('.' + event.key).classList.add('use'); break;
        case 'Â': document.body.querySelector('.' + event.key).classList.add('use'); break;
        case 'À': document.body.querySelector('.' + event.key).classList.add('use'); break;
        case 'Ï': document.body.querySelector('.' + event.key).classList.add('use'); break;
        case 'Ð': document.body.querySelector('.' + event.key).classList.add('use'); break;
        case 'Î': document.body.querySelector('.' + event.key).classList.add('use'); break;
        case 'Ë': document.body.querySelector('.' + event.key).classList.add('use'); break;
        case 'Ä': document.body.querySelector('.' + event.key).classList.add('use'); break;
        case '×': document.body.querySelector('.' + event.key).classList.add('use'); break;
        case 'Ñ': document.body.querySelector('.' + event.key).classList.add('use'); break;
        case 'Ì': document.body.querySelector('.' + event.key).classList.add('use'); break;
        case 'È': document.body.querySelector('.' + event.key).classList.add('use'); break;
        case 'Ò': document.body.querySelector('.' + event.key).classList.add('use'); break;
        case 'Ü': document.body.querySelector('.' + event.key).classList.add('use'); break;
        case 'Á': document.body.querySelector('.' + event.key).classList.add('use'); break;
        case 'Þ': document.body.querySelector('.' + event.key).classList.add('use'); break;
        ...
        case 'Control': document.body.querySelector('.ctrl').classList.add('use'); break;
        case 'Win': document.body.querySelector('.win').classList.add('use'); break;
