...
var currentTool = document.querySelector('#pencil');;
...
if (idt !== null && size !== null) {
    let size = localStorage.getItem('Size') || null;
    let img = new Image;
    img.src = idt;
    img.onload = function () {
        if (sizeInput.value === '') {
    ...
    (idt !== null) ? alert('Load failed, localStorage item Size not found') : alert('Load failed, localStorage item imgData not found');
}
